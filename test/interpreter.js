...
const {Environment, evaluate} = require("../src/interpreter");
const InputStream = require("../src/interpreter/parsing/InputStream");
const Parser = require("../src/interpreter/parsing/Parser");
const TokenStream = require("../src/interpreter/parsing/TokenStream");
