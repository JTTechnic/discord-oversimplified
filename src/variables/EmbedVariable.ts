			...
			definition: Object.assign(
				...
				},
				{
					...
					footer: Object.assign(
						...
						{
							icon: (icon: string) => {
								if (!this.lastEmbed.footer)
									throw new Error("Can't set footer icon before setting footer");
					...
					author: Object.assign(
						...
						{
							icon: (icon: string) => {
								if (!this.lastEmbed.author)
									throw new Error("Can't set author icon before setting author");
								this.definition.author(this.lastEmbed.author.name, icon);
							},
							url: (url: string) => {
								if (!this.lastEmbed.author)
									throw new Error("Can't set author url before setting author");
					...
					fields: {
						add: (name: string, value: string, inline?: boolean) =>
							this.definition.field(name, value, inline),
